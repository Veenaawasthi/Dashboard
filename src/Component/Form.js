      ...
      <form onSubmit={handleSubmit}>
        <div id="itineraryForm">
          <div
            ...
            <div className="form-row">
              <label htmlFor="name" style={{  fontWeight: "bold",  marginBottom: "5px",  display: "inline-block",  }} >
                Name:
              </label>
        ...
        <div className="form-table" style={{ marginTop: "10px" }}>
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead>
              <tr>
                <th style={{ border: "1px solid #ddd", padding: "8px", textAlign: "left", alignItems: "center", textDecoration: "none", }} >
                  <img src={"/day.png"} alt={"day"} style={{ padding: "0.5px", width: "14px", height: "14px", }} />
                  Day
                </th>
                <th style={{ border: "1px solid #ddd", padding: "8px", textAlign: "left", alignItems: "center", textDecoration: "none", }}>                  
                  <img src={"/date.png"} alt={"date"} style={{ padding: "0.5px", width: "14px", height: "14px", }} />
                  Date
                </th>
                <th style={{ border: "1px solid #ddd", padding: "8px", textAlign: "left", alignItems: "center", textDecoration: "none", }} >
                  <img src={"/city.png"} alt={"city"} style={{ padding: "0.5px", width: "14px", height: "14px", }} />
                  City
                </th>
                <th style={{ border: "1px solid #ddd", padding: "8px", textAlign: "left", alignItems: "center", textDecoration: "none", }} >
                  <img src={"/activity.png"} alt={"activity"} style={{ padding: "0.5px", width: "14px", height: "14px" }} />
                  Service
                </th>
                <th style={{ border: "1px solid #ddd", padding: "8px", textAlign: "left", alignItems: "center", textDecoration: "none", }} >
                  <img src={"/duration.png"} alt={"duration"} style={{ padding: "0.5px", width: "14px", height: "14px" }} />
                  Duration
                </th>
                <th style={{ border: "1px solid #ddd", padding: "8px", textAlign: "left", alignItems: "center", textDecoration: "none", }} >
                  <img src={"/mode.png"} alt={"mode"} style={{ padding: "0.5px", width: "14px", height: "14px", }} />
                  Mode
                </th>
                <th style={{ border: "1px solid #ddd", padding: "8px", textAlign: "left", alignItems: "center", textDecoration: "none", }} >
                  <img src={"/meal.png"} alt='meal' style={{ padding: "0.5px", width: "14px", height: "14px" }} />
                  Meal
                </th>
              </tr>
            </thead>
            <tbody>
              {formState?.days?.map((day, dayIndex) => (
                <tr key={dayIndex}>
                  ...
                  <td style={{ border: "1px solid #ddd", padding: "8px", textAlign: "left", }} >
                    <select value={day.service} onChange={(e) => handleServiceChange(dayIndex, 0, e)} style={{ width: "calc(100% - 10px)", padding: "8px", border: "1px solid #ccc", borderRadius: "4px", fontSize: "14px", }}>
              ...
              <tr>
                <td  colSpan="7"  style={{  border: "1px solid #ddd",  padding: "8px", textAlign: "left"  }} >
                  <button  type="button"  onClick={addDay}  style={{  padding: "8px 12px",  border: "none",  backgroundColor: "#007bff",  color: "#fff",  borderRadius: "4px",   cursor: "pointer",  }}  >
                    + Add Day
                  </button>
                </td>
              </tr>
        ...
        <div className="form-table" style={{ marginTop: "10px" }}>
          ...
          <button  type="button"  onClick={addHotel}  style={{  marginTop: "10px",  padding: "8px 16px",  fontSize: "14px",  backgroundColor: "#4CAF50",color: "white",  border: "none",  borderRadius: "4px",  cursor: "pointer",  }}  >
            Add Hotel
          </button>
        </div>
        ...
        <div className="form-table" style={{ marginTop: "10px" }}>
                ...
                <tr key={index}>
                  ...
                  <td  style={{ border: "1px solid #ddd",  padding: "8px",  textAlign: "left",  }} >
                    {quotationSlabs.length !== 1 && (
                      <button  type="button"  onClick={() => removeQuotationSlabRow(index)}  style={{ backgroundColor: "#dc3545", color: "#fff", border: "none", padding: "6px 12px", borderRadius: "4px", cursor: "pointer",  width: "100%",  }}  >
                        Remove
                      </button>
                    )}
                  </td>
          ...
          <button type="button" onClick={addQuotationSlabRow} style={{  marginTop: "10px",  padding: "8px 16px",  fontSize: "14px",  backgroundColor: "#4CAF50",  color: "white",  border: "none",  borderRadius: "4px",  cursor: "pointer",  }}  >
            Add Row
          </button>
        </div>
        ...
        <div style={{ marginTop: "20px" }}>
          {formData ? (
            <button  onClick={handleUpdate} style={{  padding: "10px 20px",  marginRight: "10px",  border: "none",  backgroundColor: "#28a745",  color: "#fff",  borderRadius: "4px",   cursor: "pointer",  }} >
              Update
            </button>
          ) : (
            <button  type="submit" style={{  padding: "10px 20px",  marginRight: "10px",  border: "none",  backgroundColor: "#28a745",  color: "#fff",  borderRadius: "4px",  cursor: "pointer",  }} >
              Submit
            </button>
          )}
          <button  type="button"  onClick={() => navigate("/dashboard")}  style={{  padding: "10px 20px",  border: "none",  backgroundColor: "#dc3545",  color: "#fff",  borderRadius: "4px",  cursor: "pointer",  }} >
            Cancel
          </button>
        </div>
      </form>
